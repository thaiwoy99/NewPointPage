...
export function MobileProtocolCard({
  name,
  logo,
  points,
  rank,
  ...
  // This Chunks extra entries into groups of 3 for carousel
  ...
  return (
    <motion.div
      className={cn(
        "relative rounded-xl border cursor-pointer p-4 bg-white/60 dark:bg-zinc-900/50",
        "shadow-md transition-all duration-300 overflow-hidden group",
        "hover:scale-[1.02] hover:shadow-lg flex flex-col justify-between",
        comingSoon && "min-h-[200px]"
      )}
    ...
    >
          ...
          <Tooltip.Root>
            <Tooltip.Trigger asChild>
              ...
              >
                ...
                >
                  <Gift className="h-6 w-6 text-[#86efac]" />
                  <h3
                    className={cn(
                      "text-base font-bold bg-gradient-to-r from-[#86efac] to-[#6ee7b7] bg-clip-text text-transparent"
                    )}
                  >
                    Coming Soon
                  </h3>
            ...
            <Tooltip.Portal>
              <Tooltip.Content
                side="top"
                className="z-50 rounded-md bg-zinc-800 px-2 py-1 text-xs text-white shadow-md"
              >
        ...
        <Tooltip.Provider>
          <Tooltip.Root>
            <Tooltip.Trigger asChild>
              <span
                className={cn(
                  "w-auto top-3 mb-3 right-3 text-xs font-bold py-1 px-2 rounded-md bg-opacity-90 text-white cursor-default",
                  rankColor
                )}
              >
                Rank #{rank}
      ...
      <h2 className="text-base font-bold text-zinc-200">{name}</h2>
      ...
      {!comingSoon && (
        <div className="mt-4">
          ...
          <motion.p
            className="text-base font-extrabold mb-2 tracking-tight text-black dark:text-white"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      {requiresTwitter && !twitterUsername && (
        <Dialog>
          <DialogTrigger asChild>
            <Button
              className={cn(
                "mt-4 w-full rounded-lg bg-transparent border border-zinc-600",
                "text-xs font-medium text-zinc-200 hover:bg-[#86efac] hover:text-zinc-900",
          ...
          <DialogContent
            className={cn(
              ...
              "w-full h-full text-zinc-200 animate-fade"
            )}
          >
            <DialogHeader>
              {/* <DialogTitle className="text-base font-semibold flex justify-between items-center">
                Connect Your Twitter (X)
              </DialogTitle> */}
            </DialogHeader>

            {/* Connect Twitter */}
            <div className="flex items-center justify-between p-3 rounded-lg shadow-sm transition hover:shadow-lg">
              <div className="flex items-center gap-2">
                <span className="text-white text-sm">Connect Your</span>
                <FaXTwitter className="text-blue-400 w-4 h-4" />
              ...
              {isTwitterConnected ? (
                ...
                <Button
                  ...
                  disabled={loading}
                  className={`bg-[#86efac] hover:bg-[#86efac] cursor-pointer text-white text-xs font-semibold px-3 py-1 rounded-md shadow-md transition ${
                    loading
      ...
      {!comingSoon && extra && !(requiresTwitter && !twitterUsername) && (
        <Dialog>
          <DialogTrigger asChild>
            <Button
              className={cn(
                "w-full rounded-lg bg-transparent border border-zinc-600",
                "text-xs font-medium text-zinc-200 hover:bg-[#86efac] hover:text-zinc-900",
                "transition-colors duration-200 focus-visible:outline-none",
                "focus-visible:ring-2 focus-visible:ring-[#86efac]/60"
              )}
          ...
          >
            ...
            >
              ...
              <div className="grid gap-3">
                <h3 className="text-base font-semibold text-[#86efac]">
                  Your Contributions
                </h3>
                <div className="max-h-[60vh] overflow-y-auto pr-2">
                  <div className="grid gap-2">
                    {extraEntries.map(([key, { value, url }]) => (
                      <motion.div
                        key={key}
                        className="flex items-center justify-between p-3 rounded-lg bg-zinc-800/50 border border-zinc-700 shadow-sm"
      ...
      {/* Spacer for Coming Soon cards */}
      {comingSoon && <div className="flex-1"></div>}
    </motion.div>
  );
}
...
//                   <h3
//                     className={cn(
//                       "text-xl font-bold bg-gradient-to-r from-[#86efac] to-[#6ee7b7] bg-clip-text text-transparent"
//                     )}
//                   >
//                     Coming Soon
//                   </h3>
...
//         />
//         <div>
//           {/* <h2 className="text-lg font-bold text-zinc-200">{name}</h2> */}
//           {description && (
//             <p className="text-xs text-zinc-500 dark:text-zinc-400 line-clamp-2">
//               {description}
//             </p>
...
//             <Button
//               className={cn(
//                 "mt-4 w-full rounded-lg bottom-2 bg-transparent border border-zinc-600",
//                 "text-xs font-medium text-zinc-200 hover:bg-[#86efac] hover:text-zinc-900",
//                 "transition-colors duration-200 focus-visible:outline-none",
//                 "focus-visible:ring-2 focus-visible:ring-[#86efac]/60"
//               )}
